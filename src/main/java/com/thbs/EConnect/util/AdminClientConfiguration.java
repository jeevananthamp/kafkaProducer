...
public class AdminClientConfiguration  extends AbstractConfig{
	static String PRODUCER_TOPIC;
	static String CONSUMER_TOPIC;
	Properties prop = new Properties();
	SetDefnitionProperties setConfig;
	public AdminClientConfiguration(ConfigDef config, Properties parsedConfig) {
...
public Properties getProducerProperties() {
  ...
  public AdminClientConfiguration(Properties properties) {
