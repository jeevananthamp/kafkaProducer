...
public class ControlCenterConfiguration extends AbstractConfig{
	static String PRODUCER_TOPIC;
	static String CONSUMER_TOPIC;
	Properties prop = new Properties();
	SetDefnitionProperties setConfig;
	public ControlCenterConfiguration(ConfigDef config, Properties parsedConfig) {
...
public Properties getProducerProperties() {
  ...
  public ControlCenterConfiguration(Properties properties) {
