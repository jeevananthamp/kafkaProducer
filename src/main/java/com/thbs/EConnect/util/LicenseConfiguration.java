...
public class LicenseConfiguration extends AbstractConfig{
	static String PRODUCER_TOPIC;
	static String CONSUMER_TOPIC;
	Properties prop = new Properties();
	SetDefnitionProperties setConfig;
	public LicenseConfiguration(ConfigDef config, Properties parsedConfig) {
...
public Properties getProducerProperties() {
  ...
  public LicenseConfiguration(Properties properties) {
