...
public class DockerConfiguration  extends AbstractConfig{
	static String PRODUCER_TOPIC;
	static String CONSUMER_TOPIC;
	Properties prop = new Properties();
	SetDefnitionProperties setConfig;
	public DockerConfiguration(ConfigDef config, Properties parsedConfig) {
...
public Properties getProducerProperties() {
  ...
  public DockerConfiguration(Properties properties) {
