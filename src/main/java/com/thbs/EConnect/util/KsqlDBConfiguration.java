...
public class KsqlDBConfiguration extends AbstractConfig{
	static String PRODUCER_TOPIC;
	static String CONSUMER_TOPIC;
	Properties prop = new Properties();
	SetDefnitionProperties setConfig;
	public KsqlDBConfiguration(ConfigDef config, Properties parsedConfig) {
...
public Properties getProducerProperties() {
  ...
  public KsqlDBConfiguration(Properties properties) {
